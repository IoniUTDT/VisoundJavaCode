...
public class LevelInterfaz {
	...
	private Trial trial;
	private AnalisisUmbralAngulos analisis;
	
	public LevelInterfaz (Level levelInfo, int trialNumber, Trial trial, AnalisisUmbralAngulos analisis){
		this.trial = trial;
	...
	public void renderTitle (SpriteBatch batch, OrthographicCamera cameraGUI) {
		...
		Assets.instance.fonts.defaultFont.draw(batch, "Convergencia cuandrante 1: "+ this.analisis.convergencia(0), cameraGUI.viewportWidth*3/5, cameraGUI.viewportHeight*16/20);
		Assets.instance.fonts.defaultFont.draw(batch, "Convergencia cuandrante 2: "+ this.analisis.convergencia(1), cameraGUI.viewportWidth*3/5, cameraGUI.viewportHeight*17/20);
		Assets.instance.fonts.defaultFont.draw(batch, "Convergencia cuandrante 3: "+ this.analisis.convergencia(2), cameraGUI.viewportWidth*3/5, cameraGUI.viewportHeight*18/20);
		Assets.instance.fonts.defaultFont.draw(batch, "Convergencia cuandrante 4: "+ this.analisis.convergencia(3), cameraGUI.viewportWidth*3/5, cameraGUI.viewportHeight*19/20);
