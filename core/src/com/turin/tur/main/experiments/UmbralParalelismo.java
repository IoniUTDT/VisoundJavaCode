...
public class UmbralParalelismo {

	private static final String TAG = UmbralParalelismo.class.getName();
	...
	public void makeLevels() {
		...
		this.info = json.fromJson(UmbralParalelismo.Info.class, savedData);
